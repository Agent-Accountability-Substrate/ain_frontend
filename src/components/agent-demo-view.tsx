    ...
    >
      <div className="dashboard-workspace">
        ...
        >
          ...
          <article id="lifecycle-history" className="dashboard-rail-card">
            <div className="flex items-center justify-between">
              ...
              <span className="flex h-10 w-10 items-center justify-center rounded-md bg-success-wash text-success-strong">
          ...
          <article className="dashboard-rail-card">
            <div className="flex items-center justify-between">
              ...
              <span className="flex h-10 w-10 items-center justify-center rounded-md bg-wash-blue text-cobalt">
          ...
          <div className="p-5">
            ...
            >
              ...
              <ul className="mt-3 flex flex-wrap gap-2">
                ...
                <li className="dashboard-scope-chip">customer_comms.send</li>
              </ul>
            </div>
