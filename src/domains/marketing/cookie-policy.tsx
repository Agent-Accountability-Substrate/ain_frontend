...
export function CookiePolicy() {
  return (
    <PublicInformationPage
      ...
      introduction="This policy explains when the Subra website uses cookies and what choices are available to you. The current public site uses only the cookies needed when a visitor chooses to enter the authenticated product."
      sections={SECTIONS}
