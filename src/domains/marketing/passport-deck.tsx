...
/** The AIN Registry glyph on the card's masthead. */
...
function CardOrbit() {
  return (
    <span
      aria-hidden="true"
      className="absolute top-[15%] right-[-11.25%] z-[2] block aspect-square w-[62.5%] opacity-90"
    >
...
function PassportFront({ version }: { version: PassportVersion }) {
  return (
    <div className="absolute inset-0 flex flex-col px-[22px] pt-5 pb-[18px] [backface-visibility:hidden] [transform:rotateY(0deg)]">
...
function PassportBack({ version }: { version: PassportVersion }) {
  return (
    <div className="absolute inset-0 flex flex-col px-[22px] pt-5 pb-[18px] text-site-ink [backface-visibility:hidden] [transform:rotateY(180deg)]">
            ...
            >
              <div
                className={cn(
                  ...
                  isActive && flipped && "[transform:rotateY(180deg)]",
                )}
              >
                <PassportFront version={version} />
                <PassportBack version={version} />
              </div>
