# CLAUDE.md — ain_frontend

Thin pointer. Canonical guidance lives in the **[`ain_docs`](https://github.com/Agent-Accountability-Substrate/ain_docs)** repo — [`CLAUDE.md`](https://github.com/Agent-Accountability-Substrate/ain_docs/blob/main/CLAUDE.md) and [`architecture.md`](https://github.com/Agent-Accountability-Substrate/ain_docs/blob/main/architecture.md). This file notes only what's specific to `ain_frontend`.
